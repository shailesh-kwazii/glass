// All Firebase imports removed - using local API only
...
// Firebase mode removed - always use local API

// Firebase conversion functions removed - data comes directly from local API
