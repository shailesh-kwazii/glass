...
export class MainHeader extends LitElement {
    ...
    connectedCallback() {
        ...
        if (window.require) {
            ...
            ipcRenderer
                .invoke('get-continuous-listening-state')
                .then(({ isListening }) => {
                ...
                >
                    <div class="action-text">
                        <div class="action-text-content">
                            ${!this.isSessionActive ? 'Listen' : this.isProcessing ? 'Processing...' : this.isPaused ? 'Resume' : 'Pause'}
                        </div>
                    </div>
                    ...
                    <div class="icon-container showhide-icons">
                        ...
                        <div class="icon-box">
                            <svg viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M1.50391 1.32812L5.16391 10.673"
                                    stroke="white"
                                    stroke-width="1.4"
