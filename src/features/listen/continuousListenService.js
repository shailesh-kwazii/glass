...
class ContinuousListenService {
    ...
    async resumeListening() {
        ...
        console.log('[ContinuousListenService] Current state:', {
            isListening: this.isListening,
            isPaused: this.isPaused,
            isProcessingLLM: this.isProcessingLLM,
        });
    ...
    getConversationText() {
        return this.conversationHistory.map(entry => `[${entry.timestamp}] ${entry.speaker}: ${entry.text}`).join('\n');
    }
